...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Designation permanently?","delete_designation",[$(this).attr('data-id')])
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Edit Designation Details",'maintenance/manage_designation.php?id='+$(this).attr('data-id'))
		})
